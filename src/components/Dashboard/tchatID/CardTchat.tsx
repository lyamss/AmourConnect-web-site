...
export const CardTchat = (props: {
    ...
    return (
        <div className="w-full max-w-xl mx-auto p-14">
            <div className="h-[60vh] overflow-y-auto px-4 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                    ...
                    props.messageDto
                        ...
                        .map((messagedto: GetMessageDto) => (
                            ...
                            >
                                ...
                                >
                                    <Link href={`/profil-details/${messagedto.idUserIssuer === props.UserAuthDto?.id_User 
